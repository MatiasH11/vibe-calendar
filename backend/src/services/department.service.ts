...
export const department_service = {
   ...
   * @param company_id - Company ID to filter by. If undefined, returns departments from all companies (SUPER_ADMIN only)
   */
  async getAll(company_id: number | undefined, filters: department_filters) {
